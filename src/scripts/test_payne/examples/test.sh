...
#                       --reload-payne "true" \
                       ...
                       --assume-scaled-solar \
                       --output-file "../../../output_data/payne/new_payne_galah_censored_hrs_10label_10neuron" \
                       --neuron-count "10"
...
#                        --labels "Teff,logg,[Fe/H],[Ca/H],[Mg/H],[Ti/H],[Si/H],[Na/H],[Ni/H],[Cr/H]" \
#                        --assume-scaled-solar \
#                        --output-file "../../../output_data/payne/new_payne_galah_censored_hrs_10label_20neuron" \
#                        --neuron-count "20"
