...
python3 payne_test2.py --train "galah_training_sample_4fs_hrs[SNR=250]" \
                       ...
                       --num-testing-workers 1 \
                       --output-file "../../../output_data/payne/pepsi_payne_galah_censored_hrs_3label_10neuron" \
                       --neuron-count "10"
...
#                        --num-training-workers 40 \
#                        --num-testing-workers 1 \
#                        --output-file "../../../output_data/payne/pepsi_payne_galah_censored_hrs_10label_10neuron" \
#                        --neuron-count "10"
